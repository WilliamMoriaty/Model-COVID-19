...
critical
gene<-read.table("/project/wangshun/work/R/COVID-19/IL6.txt")
...
write.csv(newdata, "Immune_IL6_Normal.csv")
...
write.csv(newdata, "Immune_IL6_Moderate.csv")
...
newdata=rbind(a1, a2, a3, a4, a5, a6,a7,a8,a9,a10,a11,a12,a13)
write.csv(newdata, "Immune_IL6_Critical.csv")
