...
struct IMD
{
  ...
  double eps_1,eps_2,eps_3,eps_4,eps_5;// eps_1: antiviral lammbda2;eps_2:antiviral K1;eps_3:antibody delta_4;eps_4:immune therapy K4; eps_5:clear infected cell
